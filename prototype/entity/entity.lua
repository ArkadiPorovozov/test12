...
sapace_asm.name = "space-assembler"
...
sapace_asm.selection_box = {{-1.25, -1.25}, {1.25, 1.25}}
sapace_asm.source_inventory_size = 1
sapace_asm.result_inventory_size = 1
sapace_asm.damaged_trigger_effect = hit_effects.entity()
sapace_asm.crafting_categories = {"glass-furnace-smelting"}
sapace_asm.crafting_speed = 1
